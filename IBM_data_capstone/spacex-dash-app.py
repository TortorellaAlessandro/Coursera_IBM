...
def get_pie_chart(entered_site):
    ...
    if entered_site == 'ALL':
        ...
        fig = px.pie(
            ...
            values='Count',
            names='Outcome',
            title=f'Esiti per il sito: {entered_site}'
        )
    return fig
# TASK 4:
...
def get_scatter_plot(entered_site, payload_range):
    ...
    if entered_site== "ALL":
        fig= px.scatter(
            ...
            title= "Success of each booster version in alla sites given a specific payload mass"
        )
    else:
        ...
        fig= px.scatter(
            ...
            y= "class",
            color= "Booster Version Category",
            title= f"Success of each booster version in the {entered_site} site given a specific payload mass"
        )
    return fig
# Run the app
